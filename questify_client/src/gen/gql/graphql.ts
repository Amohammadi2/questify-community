...
export type GetNotificationsQuery = { __typename?: 'Query', notifications?: { __typename?: 'NotificationTypeConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ __typename?: 'NotificationTypeEdge', node?: { __typename?: 'NotificationType', id: string, message: string, seen: boolean } | null } | null> } | null };
