...
import { IQuestionContent } from "../interfaces/question-content.interface";

export function useQuestionContent(qid: string) {
  const [fetchData, stats] = useMockAPI<void, IQuestionContent>({
    delay: 800,
    handler: () => {
      return {
        title: 'وارون کلی تابع درجه دو به چه شکل است؟',
        content: `
