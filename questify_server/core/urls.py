...
urlpatterns = [
    ...
    # GraphQL
    # Note: we are excluding this view from the OPEN API schema generated by drf spectacular
    path("graphql/", csrf_exempt(extend_schema(exclude=True)(DRFAuthenticatedGraphQLView.as_view(graphiql=True)))),
